...
<xsl:template match="identAndStatusSection">
  <div class="identAndStatusSection">
    ...
    <table>
      ...
      <tr>
        <td><b>PM Code: </b></td>
        <td><xsl:value-of select="php:function('Ptdi\Mpub\CSDB::resolve_pmCode', //pmAddress/descendant::pmCode)"/></td>
      </tr>
      <tr>
        <td><b>Issue Number: </b></td>
        <td><xsl:value-of select="//pmAddress/descendant::issueInfo/@issueNumber"/></td>
      </tr>
      <tr>
        <td><b>InWork Number: </b></td>
        <td><xsl:value-of select="//pmAddress/descendant::issueInfo/@inWork"/></td>
      </tr>
      <tr>
        <td><b>Issue Date: </b></td>
        <td><xsl:value-of select="php:function('Ptdi\Mpub\CSDB::resolve_issueDate', //pmAddress/descendant::issueDate)"/></td>
      </tr>
      <tr>
        <td><b>Title: </b></td>
        <td><xsl:value-of select="php:function('Ptdi\Mpub\CSDB::resolve_pmTitle', //pmAddress/descendant::pmTitle)"/></td>
      </tr>
    
      <!-- pmStatus -->
      <tr>
        <td><b>Security Classification: </b></td>
        <td><xsl:value-of select="pmStatus/security/@securityClassification"/></td>
      </tr>
      <tr>
        <td><b>Responsible Partner Company: </b></td>
        <td><xsl:value-of select="php:function('Ptdi\Mpub\CSDB::resolve_responsiblePartnerCompany', pmStatus/responsiblePartnerCompany, 'both')"/></td>
      </tr>
      <tr>
        <td><b>Originator: </b></td>
        <td><xsl:value-of select="php:function('Ptdi\Mpub\CSDB::resolve_responsiblePartnerCompany', pmStatus/originator, 'both')"/></td>
      </tr>
      <tr>
        <td><b>ACT: </b></td>
