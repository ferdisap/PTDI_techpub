<section>
  ...
  <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
      ...
      <div>
          <x-input-label for="current_password" :value="__('Current Password')" style="width: 100px"/>
      ...
      <div>
          <x-input-label for="password" :value="__('New Password')" style="width: 100px"/>
          <x-text-input id="password" name="password" type="password" class="mt-1" autocomplete="new-password" />
          <x-input-error :messages="$errors->updatePassword->get('password')" class="mt-2" />
      </div>

      <div>
          <x-input-label for="password_confirmation" :value="__('Confirm Password')" style="width: 100px"/>
