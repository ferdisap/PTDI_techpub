<section>
  ...
  <form method="post" action="{{ route('profile.update') }}" class="mt-2 ms-3">
      @csrf
      @method('patch')

      <div class="mb-2">
          <x-input-label for="name" :value="__('Name')" style="width: 50px"/>
      ...
      <div class="mb-2">
          <x-input-label for="email" :value="__('Email')" style="width: 50px"/>
          ...
          @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
              <div>
                  <p class="fs-6 mt-2">
                      ...
                      <button form="send-verification" class="text-decoration-underline fs-6 rounded">
