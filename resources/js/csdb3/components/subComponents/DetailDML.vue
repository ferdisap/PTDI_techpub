...
<template>
  ...
  <!-- if is in COMMITING area -->
  <div class="w-full text-center mb-3 mt-3" v-if="!$props.isInEditing">
    <button :class="[showDML == 'addEntry' ? 'border-b-black border-b-4' : '' ,'button-nav']" @click="showDML != 'addEntry' ? (showDML = 'addEntry') : (showDML = '')">Add Entry</button>
